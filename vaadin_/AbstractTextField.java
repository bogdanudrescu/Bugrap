...
public abstract class AbstractTextField extends AbstractField<String> implements
    ...
    public void changeVariables(Object source, Map<String, Object> variables) {
        ...
        try {
            ...
            // TODO: The height and width should be set in TextArea actually,
            // but what to do with changingVariables private field?
            // Is is OK to handle this here?

            // Sets the height set by the user when resize the textarea.
            String newHeight = (String) variables.get("height");
            System.err.println("changeVariables:newHeight: " + newHeight);
            if (newHeight != null) {
                setHeight(newHeight);
            }
            ...
            System.err.println("changeVariables:newWidth: " + newWidth);
            if (newWidth != null) {
                setWidth(newWidth);
            }
